...
hl.window_rule({ name = "ff-pip-float", match = { class = "^(firefox)$", title = "^(Picture-in-Picture)$" }, float = true })
hl.window_rule({ name = "ff-pip-pin", match = { class = "^(firefox)$", title = "^(Picture-in-Picture)$" }, pin = true })
hl.window_rule({ name = "ff-sharing-indicator", match = { class = "^(firefox)$", title = "^(Firefox — Sharing Indicator)$" }, float = true })

hl.window_rule({ name = "telegram-media-fullscreen", match = { class = "^(org.telegram.desktop)$", title = "^(Media viewer)$" }, fullscreen = true })
...
hl.window_rule({ name = "chrome-open-files", match = { class = "^(google-chrome)$", title = "^(Open Files)$" }, float = true })
hl.window_rule({ name = "chrome-open-file", match = { class = "^(google-chrome)$", title = "^(Open File)$" }, float = true })
...
-- Kept from the example template (not in legacy conf)
